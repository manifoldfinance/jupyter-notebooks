...
if [ "$(whoami)" = "auto" ] || [ "$(whoami)" = "automatic" ]; then
    USERNAME=""
...
addToJupyterConfig() {
  # macOS
  ## /Users/"$(whoami)"/Library/Jupyter/jupyter_notebook_config.py
  JUPYTER_DIR="/home/"$(whoami)"/.jupyter"
